...
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( !class_exists( 'LearnDash_Settings_Section_Translations_Learndash_Paid_Memberships' ) ) ) {
	class LearnDash_Settings_Section_Translations_Learndash_Paid_Memberships extends LearnDash_Settings_Section {

		// Must match the Text Domain
		private $project_slug = 'learndash-paidmemberships';
		...
		function __construct() {
			...
			$this->settings_section_label			=	__( 'LearnDash Paid Memberships Pro', 'learndash-paidmemberships' );
			...
			if ( class_exists( 'LearnDash_Translations' ) ) {
				...
				if ( method_exists( 'LearnDash_Translations', 'register_translation_slug' ) ) {
					...
					LearnDash_Translations::register_translation_slug( $this->project_slug, LEARNDASH_PMP_PLUGIN_PATH . 'languages' );
				} 
			} 
	...
	add_action( 'init', function() {
		LearnDash_Settings_Section_Translations_Learndash_Paid_Memberships::add_section_instance();
	} );
}
